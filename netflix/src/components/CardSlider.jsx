...
const CardSlider = ({title,data}) => {
    ...
    // 
  return (
    <Container showControls={showControls} className='flex column' onMouseEnter={()=>setShowControls(true)} onMouseLeave={()=>setShowControls(false)}>
        <h1>{title}</h1>
